...
func _start_turn() -> void:
	...
	print("Ход героя начался. AP: ", current_ap, " Move Budget: ", move_budget, "/", max_move_budget)


# Обработка ввода (используем _input вместо _unhandled_input)
...
# Получить все способности (для UI)
